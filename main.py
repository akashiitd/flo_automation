...
def _questions_scan(
    ...
    *,
    ...
    print(f"Skill parameters: {result.skill_parameters_path}")
    print(f"Skill ratings before: {result.skill_parameters_before_screenshot_path}")
    print(f"Skill ratings after: {result.skill_parameters_after_screenshot_path}")
    print(f"Skill section DOM: {result.skill_section_dom_path}")
